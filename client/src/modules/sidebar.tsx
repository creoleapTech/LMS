...
const navItems: NavItem[] = [
  ...
  { name: 'Assessments', path: '/examinations', icon: <ClipboardList className="w-5 h-5" />, roles: ['super_admin', 'staff', 'teacher', 'student'] },
  { name: 'Quizzes', path: '/quizzes', icon: <HelpCircle className="w-5 h-5" />, roles: ['super_admin', 'teacher'] },
  { name: 'Students', path: '/students', icon: <GraduationCap className="w-5 h-5" />, roles: ['admin', 'super_admin', 'teacher'] },
